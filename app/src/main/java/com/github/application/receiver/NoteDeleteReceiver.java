...
/**
 * Created by ZhongXiaolong on 2019/12/26 17:27.
 */
public class NoteDeleteReceiver extends BroadcastReceiver {

    private static final String ACTION = "com.github.application.note.delete";
    private Context mContext;
    private OnReceiveCall mOnReceiveCall;

    public NoteDeleteReceiver(Context context, OnReceiveCall onReceiveCall) {
        mContext = context;
