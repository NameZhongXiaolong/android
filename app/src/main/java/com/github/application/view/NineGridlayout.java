...
public class NineGridlayout extends ViewGroup {
    ...
    public NineGridlayout(Context context, AttributeSet attrs) {
        super(context, attrs);
//        totalWidth= UnitUtils.displayWidth() -UnitUtils.dp(80);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        totalWidth = r - l;
        Log.d("NineGridlayout", "onLayout" + totalWidth);

//        Log.d("NineGridlayout", "r-l:" + (r - l));
//        Log.d("NineGridlayout", "b-t:" + (b - t));
    }
    private void layoutChildrenView(){
        int childrenCount = listData.size();

        Log.d("NineGridlayout1", "totalWidth:" + totalWidth);
...
//        Log.d("NineGridlayout", "getWidth():" + getWidth());
//        Log.d("NineGridlayout", "getMeasuredWidth():" + getMeasuredWidth());
    }
}
