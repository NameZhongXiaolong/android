...
/**
 * Created by ZhongXiaolong on 2018/12/3 17:56.
 * <p>
 * 进度Button
 */
public class LoadButton extends View {
    ...
    OnLoadButtonClickListener onAnimationButtonClickListener;

    public LoadButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        initPaint();
    ...
    public void setLoadButtonListener(OnLoadButtonClickListener onAnimationButtonClickListener) {
